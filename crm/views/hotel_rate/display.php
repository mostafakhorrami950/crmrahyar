...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .date-range { display: inline-flex; align-items: center; gap: 4px; background: #e8f4f8; color: #0c5460; padding: 3px 10px; border-radius: 8px; font-size: 11px; font-weight: 600; direction: ltr; }
        ...
        @media (max-width: 768px) { .rate-table { font-size: 11px; } .rate-table thead th, .rate-table tbody td { padding: 6px 8px; } .price-cell { font-size: 11px; } }
        @media print { body { background: #fff !important; } .filter-bar, .no-print { display: none !important; } .hotel-card { box-shadow: none !important; break-inside: avoid; } .page-header { background: <?php echo $pc; ?> !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; } }
    </style>
</head>
<body>
                ...
                <table class="rate-table">
                    <thead>
                        <tr>
                            ...
                            <th><span class="price-type-icon">🥂</span>فولبرد<br>بوفه</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="date-range"><?php echo \Core\JDate::displayDate($rate->date_from); ?> ← <?php echo \Core\JDate::displayDate($rate->date_to); ?></span></td>
                            ...
                            <td class="price-cell highlight"><?php echo $rate->price_fulboard_boufeh > 0 ? number_format($rate->price_fulboard_boufeh) : '-'; ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
