            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="date" name="check_in_date" class="form-control" id="checkInDate" required onchange="updateAllQuantitiesAndCalc()">
                    </div>
                    <div class="col-6">
                        ...
                        <input type="date" name="check_out_date" class="form-control" id="checkOutDate" required onchange="updateAllQuantitiesAndCalc()">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number" name="persons_count" class="form-control" id="personsCount" value="1" min="1" onchange="updateAllQuantitiesAndCalc()">
                    </div>
                </div>
            </div>
        </div>
