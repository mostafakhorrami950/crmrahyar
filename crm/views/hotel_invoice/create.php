        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6"><label class="form-label text-muted small fw-medium">نام آژانس</label><input type="text" name="agency_name" class="form-control" value="<?php echo htmlspecialchars($deal->contact_name ?? ''); ?>"></div>
                    <div class="col-6"><label class="form-label text-muted small fw-medium">نام میهمان</label><input type="text" name="guest_name" class="form-control" value=""></div>
