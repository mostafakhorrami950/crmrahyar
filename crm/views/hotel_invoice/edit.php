                ...
                <div id="itemsContainer">
                    ...
                    <div class="item-row row g-2 mb-2 pb-2 border-bottom">
                        <div class="col-4">
                            ...
                            <div class="form-check mt-1"><input class="form-check-input" type="checkbox" name="item_half_price[]" value="1" style="font-size:11px;" onchange="toggleHalfPrice(this)" <?php echo !empty($item->is_half_price) ? 'checked' : ''; ?>><label class="form-check-label" style="font-size:10px;color:#e67e22;">نیم بها</label></div>
