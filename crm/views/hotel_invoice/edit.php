        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6"><label class="form-label text-muted small fw-medium">وضعیت فاکتور</label><select name="invoice_status" class="form-select"><option value="pending" <?php echo $invoice->invoice_status=='pending'?'selected':''; ?>>مانده دارد</option><option value="settled" <?php echo $invoice->invoice_status=='settled'?'selected':''; ?>>تسویه شده</option><option value="prepaid" <?php echo $invoice->invoice_status=='prepaid'?'selected':''; ?>>پیش پرداخت</option></select></div>
