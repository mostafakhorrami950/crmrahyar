    ...
    <div class="col-md-8">
        <div class="card p-0">
            ...
            <div class="table-responsive"><table class="table table-sm">
                <thead><tr><th class="text-nowrap">نام</th><th class="text-nowrap">تلفن</th><th class="text-nowrap">معاملات</th><th class="text-nowrap">موفق</th><th class="text-nowrap">مجموع خرید</th><th class="text-nowrap">آخرین معامله</th></tr></thead>
