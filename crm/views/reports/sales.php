<div class="filter-section">
    <form method="GET" class="row g-3">
        ...
        <div class="col-md-3"><label class="form-label text-muted small fw-medium">پایپ لاین</label><select name="pipeline_id" class="form-select"><option value="">همه</option><?php foreach ($pipelines as $p): ?><option value="<?php echo $p->id; ?>" <?php echo $selectedPipeline == $p->id ? 'selected' : ''; ?>><?php echo htmlspecialchars($p->name); ?></option><?php endforeach; ?></select></div>
...
<div class="card p-0">
    <div class="table-responsive">
        <table class="table">
            <thead><tr><th class="text-nowrap">عنوان</th><th class="text-nowrap">مخاطب</th><th class="text-nowrap">مرحله</th><th class="text-nowrap">مسئول</th><th class="text-nowrap">مبلغ</th><th class="text-nowrap">تاریخ</th><th class="text-nowrap">وضعیت</th></tr></thead>
